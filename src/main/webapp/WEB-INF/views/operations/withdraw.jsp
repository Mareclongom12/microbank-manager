...
<head>
    <meta charset="UTF-8">
    <title>Retrait - MicroBank Manager</title>
...
<div class="container mt-4" style="max-width: 500px;">
    ...
    <h2 class="text-warning">Retrait</h2>
    ...
    <form action="${pageContext.request.contextPath}/operations/withdraw" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="description" class="form-control" placeholder="Ex : retrait guichet">
        </div>
